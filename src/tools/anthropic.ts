...
export function createAnthropicToolRegistry(): ToolRegistry {
    ...
    registry.registerTool({ name: 'web_fetch_20250305', capabilities: { web: true, read: true }, provider: 'anthropic' });
    ...
    registry.registerAccessLevel('full', ['web_search_20250305', 'web_fetch_20250305', 'computer_use_20250124', 'text_editor_20250124', 'bash_20250124']);
    registry.registerAccessLevel('read-only', ['web_search_20250305', 'web_fetch_20250305', 'text_editor_20250124']);
    registry.registerAccessLevel('read-write-no-bash', ['web_search_20250305', 'web_fetch_20250305', 'text_editor_20250124', 'computer_use_20250124']);
    registry.registerAccessLevel('server-only', ['web_search_20250305', 'web_fetch_20250305']);

    registry.registerNameMapping('search', 'web_search_20250305');
    registry.registerNameMapping('web', 'web_fetch_20250305');
